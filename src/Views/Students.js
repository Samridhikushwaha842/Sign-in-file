...
import StudentStyles from '../CSS/Students/StudentsTheme';
...
const Student = () => {
  ...
  const styles = StudentStyles(theme);
    ...
    <Box sx={styles.container}>
      ...
      <Box sx={styles.studentListContainer}>
        ...
        <Box sx={styles.detailsContainer}>
          {selectedStudent && (
            <>
              <Box sx={styles.studentHeader}>
                <Avatar alt={selectedStudent.name} src={selectedStudent.profile} sx={styles.avatar} />
